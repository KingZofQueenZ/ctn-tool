...
export class EventService {
  ...
  update(event: Event): Observable<any> {
    return this.http.put('/api/events/' + event._id, event, {
      headers: headers,
      responseType: 'text' as 'json',
    });
  }
  ...
  delete(_id: string): Observable<Event> {
    return this.http.delete<Event>('/api/events/' + _id, {
      headers: headers,
      responseType: 'text' as 'json',
    });
  }
  ...
  addTrialParticipant(
    ...
    return this.http.post<Event>(
      '/api/events/' + eventId + '/trialparticipants/',
  ...
  // DELETE /events/{event-id}/participants-admin/{participant-id} // ADMIN
  deleteParticipantAdmin(eventId: string, userId: string): Observable<Event> {
    return this.http.delete<Event>(
      '/api/events/' + eventId + '/participants-admin/' + userId + '/',
      { headers: headers, responseType: 'text' as 'json' },
    );
  }
}
